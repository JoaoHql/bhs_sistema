...
class MockQueryRepository:
    ...
    async def fetch_sales_projection_matrix(self, schema_name: str, month: str | None, company: str | None, quantity_growth_pct: float, revenue_growth_pct: float, goal_growth_pct: float) -> dict[str, Any]:
        _ = (schema_name, month, company, quantity_growth_pct, revenue_growth_pct, goal_growth_pct)
        return {
            "month": "2026-06",
            "months": ["2026-06"],
